...
include_once("Datos.php");
	...
	class Fachada
	{
		...
		{    //____ini_insertar
			...
			$XX=fopen("/var/www/html/sicdap/insertar.txt","a");
...
$XX=fopen("/var/www/html/sicdap/modificar.txt","a");
fputs($XX,date("d/m/Y h:i a",time())."\r\n".$sql."\r\n\r\n");
...
$XX=fopen("/var/www/html/sicdap/eliminar.txt","a");
fputs($XX,date("d/m/Y h:i a",time())."\r\n".$sql."\r\n\r\n");
			//echo $sql;
			$resp=$this->mbd->consulta($sql);
            return $resp;
        ...
        {	//____ini_consultar
$XX=fopen("/var/www/html/sicdap/consultar.txt","a");
fputs($XX,date("d/m/Y h:i a",time())."\r\n".$sql."\r\n\r\n");
